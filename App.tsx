        ...
        if (lastNode.isDynamic) {
            try {
                ...
                if (currentNodeId === 'what_else_student_prompt') {
                    ...
                    contextPrompt = `You are a thoughtful and inspiring chatbot concluding a quiz about ESG. The student was asked the open-ended question: "How much do you matter in saving our Earth?".
Your task is to analyze the user's response.
- If the user gives a positive or neutral answer about their importance, provide a thoughtful and encouraging response that reinforces the idea that individual actions matter.
- If the user gives a negative answer (e.g., "I don't matter," "I'm not important," "nothing I do helps"), your response must be supportive but also corrective. Gently challenge their view by explaining WHY their thought is incorrect and emphasize their importance. For example, you can talk about the ripple effect of small actions. Do NOT ask them to provide another answer. Just provide your explanation. For these negative but relevant answers, you must still consider 'isRelevant' to be 'true'.
- If the answer is completely irrelevant (e.g., about food, sports), your 'responseText' should gently guide them back to answering the question, and 'isRelevant' should be 'false'.
Keep all responses concise and uplifting.`;
                } else if (currentNodeId === 'quiz_q7_prompt') {
