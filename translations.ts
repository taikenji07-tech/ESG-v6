...
export const translations: Translations = {
  en: {
    ...
    quiz_q3_text: "Which of these digital habits can reduce the environmental impact?",
    quiz_q4_text: "According to the 'How can I fit ESG into my daily life' section which of these is an example of a 'Governance (G)' action?",
    ...
    "btn_digital_habit_sd": "Stream videos in Standard Definition (SD)",
    "btn_digital_habit_leave_on": "Leaving your computer on 24/7",
    "btn_digital_habit_cloud": "Always using cloud storage for files",
    "btn_governance_everyday_1": "Bringing a reusable water bottle",
    "btn_governance_everyday_2": "Citing sources properly in your work",
    "btn_governance_everyday_3": "Sharing a local business on social media",
    ...
    "quiz_q1_incorrect_text": "Not quite, but close! The correct matches are:\n\n- **E** → Clean energy, reduced waste and resource conservation\n- **S** → Fair labor practices, community relations and diversity\n- **G** → Ethical leadership, transparency and shareholder rights",
    ...
    "quiz_q3_correct_text": "Correct! ✅ Streaming in SD uses significantly less data and energy than HD or 4K, reducing the carbon footprint of data centers.",
    "quiz_q3_incorrect_text": "Not quite. The correct answer is **streaming in SD**. Leaving computers on wastes energy, and cloud storage requires energy-intensive data centers to run 24/7.",
    "quiz_q4_correct_text": "Exactly! ✅ Personal governance includes accountability and transparency. Citing your sources is a perfect example of ethical and responsible conduct.",
    "quiz_q4_incorrect_text": "Good try! Citing sources properly is the 'G' action. Bringing a water bottle is 'E' (Environmental), and sharing a local business is 'S' (Social).",
    ...
    'dd_item_S_letter': "S",
    'dd_item_G_letter': "G",
    'dd_target_E_desc': "Clean energy, reduced waste and resource conservation",
    'dd_target_S_desc': "Fair labor practices, community relations and diversity",
    'dd_target_G_desc': "Ethical leadership, transparency and shareholder rights",
  ...
  ms: {
    ...
    personal_esg_pillar_e_answer_text: "Penanggung insurans beretika melabur dengan tujuan—membiayai tenaga boleh diperbaharui, bon hijau, dan syarikat beretika dan bukannya industri pencemaran tinggi.\n\nDengan memilih syarikat yang sedar ESG, premium anda bukan sahaja melindungi anda—ia juga membantu memacu kemajuan alam sekitar dan sosial.",
    ...
    quiz_q3_text: "Antara tabiat digital ini, yang manakah boleh mengurangkan kesan alam sekitar?",
    quiz_q4_text: "Menurut bahagian 'Bagaimana saya boleh menerapkan ESG dalam kehidupan harian saya', yang manakah antara berikut merupakan contoh tindakan 'Tadbir Urus (G)'?",
    ...
    "btn_digital_habit_sd": "Strim video dalam Definisi Standard (SD)",
    "btn_digital_habit_leave_on": "Membiarkan komputer anda hidup 24/7",
    "btn_digital_habit_cloud": "Sentiasa menggunakan storan awan untuk fail",
    "btn_governance_everyday_1": "Membawa botol air boleh guna semula",
    "btn_governance_everyday_2": "Memetik sumber dengan betul dalam kerja anda",
    "btn_governance_everyday_3": "Berkongsi perniagaan tempatan di media sosial",
    ...
    "quiz_q1_incorrect_text": "Tidak berapa tepat, tetapi hampir! Padanan yang betul ialah:\n\n- **E** → Tenaga bersih, pengurangan sisa dan pemuliharaan sumber\n- **S** → Amalan buruh yang adil, hubungan komuniti dan kepelbagaian\n- **G** → Kepimpinan beretika, ketelusan dan hak pemegang saham",
    ...
    "quiz_q3_correct_text": "Betul! ✅ Menstrim dalam SD menggunakan data dan tenaga yang jauh lebih sedikit daripada HD atau 4K, mengurangkan jejak karbon pusat data.",
    "quiz_q3_incorrect_text": "Tidak tepat. Jawapan yang betul ialah **menstrim dalam SD**. Membiarkan komputer hidup membazirkan tenaga, dan storan awan memerlukan pusat data yang menggunakan tenaga secara intensif untuk beroperasi 24/7.",
    "quiz_q4_correct_text": "Tepat sekali! ✅ Tadbir urus peribadi merangkumi akauntabiliti dan ketelusan. Memetik sumber anda adalah contoh sempurna kelakuan yang beretika dan bertanggungjawab.",
    "quiz_q4_incorrect_text": "Cubaan yang baik! Memetik sumber dengan betul adalah tindakan 'G'. Membawa botol air adalah 'E' (Alam Sekitar), dan berkongsi perniagaan tempatan adalah 'S' (Sosial).",
    ...
    'dd_item_S_letter': "S",
    'dd_item_G_letter': "G",
    'dd_target_E_desc': "Tenaga bersih, pengurangan sisa dan pemuliharaan sumber",
    'dd_target_S_desc': "Amalan buruh yang adil, hubungan komuniti dan kepelbagaian",
    'dd_target_G_desc': "Kepimpinan beretika, ketelusan dan hak pemegang saham",
