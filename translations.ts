...
export const translations: Translations = {
  en: {
    ...
    quiz_q4_text: "According to the 'ESG in everyday life' section which of these is an example of a 'Governance (G)' action?",
  ...
  ms: {
    ...
    quiz_q4_text: "Menurut bahagian 'ESG dalam kehidupan seharian', yang manakah antara berikut merupakan contoh tindakan 'Tadbir Urus (G)'?",
